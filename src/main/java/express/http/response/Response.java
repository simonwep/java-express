...
public class Response {
   ...
   * parameter to the file name. Normally this triggers an download event client-side.
   *
   * @param file The file which will be send as attachment.
   * @return True if the file was successfully send, false if the file doesn't exists or the respose
   *     is already closed.
   */
  ...
  /**
   * Send a byte array as response. Content type will be set to application/octet-streamFrom
   *
  ...
  private void sendHeaders() {
    try {
      ...
      // Fallback
      String contentType =
          getContentType() == null ? MediaType._bin.getExtension() : getContentType();
