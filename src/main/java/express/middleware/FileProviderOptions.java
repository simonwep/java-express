...
public class FileProviderOptions {
  ...
  /**
   * Activate the fallback-search. E.g. if an request to <code>/js/code.js</code> was made but the
   * requested resource cannot be found. It will be looked for an file called <code>code</code> and
   * return it.
   *
   * <p>Default is false.
   *
