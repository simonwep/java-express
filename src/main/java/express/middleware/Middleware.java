...
public final class Middleware {
  ...
  /**
   * Create an new cookie-session middleware. You can access and edit to session-cookie data via
   * request.getMiddlewareContent('SessionCookie').
   *
   * @param cookieName An name for the session-cookie, it's recommend to use NOT SID for security
   *     reasons
   ...
   * @throws IOException If path cannot be found or something like that
   */
  public static FileProvider statics(String directoryPath, FileProviderOptions staticOptions)
      throws IOException {
