...
public interface Router {
   ...
   * @param middleware An middleware which will be fired if the context matches the request-method-
   *     and path.
   * @return The router itself to allow method call chaining.
   */
  ...
  /**
   * Adds an handler for a specific context and method. You can use a star '*' to match every
